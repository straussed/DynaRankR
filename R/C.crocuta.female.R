...
#'    \item{contestants}{Dataframe of 295 rows and 4 variables.
...
#'    \item{female.interactions}{Dataframe of 2683 rows and 3 variables. 
#'    Each row corresponds to the outcome of one aggressive interaction among 
#'    adult females.}
#'  }
#'  
"C.crocuta.female"